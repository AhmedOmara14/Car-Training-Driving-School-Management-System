      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <div class="container-fluid">
          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar">
             ...
             <div class="col-xl-3 col-sm-6 p-2" id="btn">
                <div class="card card-common">
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <i class="fas fa-users fa-4x text-"></i>
                      <div class="text-right text-wraning">
                        <h5 class="ll">Total number of local students</h5>
                        <h3 class="back">135,000</h3>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-sm-6 p-2" id="btn2">
                <div class="card card-common">
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                     <i class="fas fa-chalkboard-teacher fa-4x"></i> 
                      <div class="text-right text-wraning">
                        <h5 class="ll">Total number of local tutors</h5>
                        <h3 class="back">135,000</h3>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-sm-6 p-2" id="btn3">
                <div class="card card-common">
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                     <i class="fas fa-car fa-4x"></i> 
                      <div class="text-right text-wraning">
                        <h5 class="ll">Total number of Sessions</h5>
                        <h3 class="back">13</h3>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-sm-6 p-2" id="btn">
                <div class="card card-common">
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <i class="fas fa-users fa-3x text-"></i>
                      <div class="text-right text-wraning">
                        <h5 class="ll">Total number of Remote students</h5>
                        <h3 class="back">135,0</h3>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                     <i class="fas fa-chalkboard-teacher fa-3x"></i> 
                      <div class="text-right text-wraning">
                        <h5 class="ll">Total number of Remote tutors</h5>
                        <h3 class="back">135</h3>
                      </div>
                    </div>
                  </div>
