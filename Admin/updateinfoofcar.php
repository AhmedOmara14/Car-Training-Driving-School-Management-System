...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-light">
      ...
      <div>
    <form  method="POST" style="margin-top: 200px; margin-left: 400px;">

    <p class="restaurantnam">package number</p>
    <input type="text" name="packagenum" class="resname" required>
    
    <p class="restaurantdes">vechial of session </p>
    <input type="text"name="vechial"  class="desname" required>
     <br>
    <input type="submit" name="insert" class="ii" value="Update" style="
    width: 106px;
    padding-left: 6px;
