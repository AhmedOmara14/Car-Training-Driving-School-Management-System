            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <ul 
                ...
                <div class="dropdown-menu"
                     ...
                     style="position: absolute; transform: translate3d(110px, 100px, 0px); top: 390px; left: 143px;">
...
">
    ...
    margin-bottom: 20px;
    ">User name of Admin</p>
    <input type="text" name="name"style="margin-left:350px; " required="">
    <br>
    <p class="restaurantdes" style="height: 30px;">Password</p>
    <input type="Password" name="pass" class="desname" required=""><br>
    <p class="age" style="
     height: 30px;
     margin-left: 350px;
     margin-top: 20px;
...
">
    ...
    <br>
     <input type="submit" name="insert" style="margin-left: 422px;margin-top: 30px;width: 66px;" class="Submit" value="Add">  
   </form>
   </div>        
