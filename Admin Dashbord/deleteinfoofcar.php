<?php
    ...
    if (isset($_POST["delete"])) {
      ...
      $table_name="package";
       $data_delete->delete($table_name,$packagenum);
...
<html lang="en">
  ...
  <body>
    ...
    <div class="divofdeleteinfo" style="
          margin-top: 80px;
           margin-left: 400px;
          ">
          <form  method="POST">    
              <h1 style="margin-left: 50px ; margin-right: -300px;"> Delete information about cars and session </h1>
       <hr style="margin-left: 280px;">
       <div style="font-size: 20px; margin-left: 370px; margin-bottom: 15px;">Package number</div>
       <input type="text" name="packagenum" style="margin-left: 350px;">

       <div style="font-size: 20px; margin-left: 400px; margin-bottom: 15px;margin-top: 10px;">name of car</div>
       <input type="text" name="vechial" style="margin-left: 350px;">
       <input type="submit" name="delete" style="margin-left: 420px; margin-top: 20px;" 
       value="Delete" />  
      </form>
