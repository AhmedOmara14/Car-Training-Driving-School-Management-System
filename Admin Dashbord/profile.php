...
<html lang="en">
  <head>
    ...
    <link rel="title icon" href="images/loc.png">
 ...
 <nav class="navbar navbar-expand-md navbar-light">
    ...
    <input type="text" name="username" class="resname" required="" style="
    margin-left: 250px;
    margin-top: 0px;
    ">
     <p class="restaurantnam" style="
    ...
    <input type="Password"name="password" class="resname" required="" style="
    margin-left: 250px;
    margin-top: 0px;
    ">
    
    <br>
     <input type="submit" name="insert" style="margin-left: 310px;margin-top: 20px;width: 100px" class="Submit" value="Update">  
   </form>
   </div>        
